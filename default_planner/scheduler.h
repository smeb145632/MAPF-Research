...
// H26: Global re-evaluation interval (in SIMULATION TIMESTEPS, not call counts)
// Every REASSESS_INTERVAL simulation timesteps, the scheduler checks assigned tasks
// EGTS evaluation frequency: lower value = more frequent reassessment
const int REASSESS_INTERVAL = 5;   // in simulation timesteps (was call counts before H50)
